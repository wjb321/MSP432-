...
//--------------IIC总线引脚定义-----------------------
#define GPIO_OLED_DAT_PORT_BASE       GPIO_PORTE_BASE//OLED屏IIC数据信号
#define GPIO_OLED_DAT_PORT_SYSCTL     SYSCTL_PERIPH_GPIOE  //OLED屏IIC时钟信号
#define GPIO_OLED_DAT_PIN             GPIO_PIN_1  //OLED屏IIC时钟信号

#define GPIO_OLED_SCLK_PORT_BASE       GPIO_PORTE_BASE  //OLED屏IIC时钟信号
#define GPIO_OLED_SCLK_PORT_SYSCTL     SYSCTL_PERIPH_GPIOE  //OLED屏IIC时钟信号
#define GPIO_OLED_SCLK_PIN             GPIO_PIN_2  //OLED屏IIC时钟信号
