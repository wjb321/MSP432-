...
PinoutSet(bool bEthernet, bool bUSB)
{
  ...
  //
  //MAP_GPIO_setAsPeripheralModuleFunctionOutputPin(GPIO_PORT_P4, GPIO_PIN_0,GPIO_PRIMARY_MODULE_FUNCTION);
